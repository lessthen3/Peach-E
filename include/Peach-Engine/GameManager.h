...
namespace PeachEngine {
    ...
    //////////////////////////////////////////////
    private:
        unique_ptr<PeachCore::LogManager> main_logger = nullptr;
        PeachCore::PeachConsole peach_engine_console;

        shared_ptr<PeachCore::CommandQueue> pm_RenderingManagerLoadingQueue = nullptr;
