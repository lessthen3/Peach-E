...
namespace PeachCore {
		...
		)
	{
		...
		resource_logger->Initialize("resource_thread", fp_LogOutputDirectory, "ResourceManager", fp_Console);
	...
	bool ResourceManager::TryPushingLoadedResourcePackage(unique_ptr<LoadedResourcePackage> fp_LoadedPackage)
	{
