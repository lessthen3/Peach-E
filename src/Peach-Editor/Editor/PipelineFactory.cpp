#include "../../../include/Peach-Editor/Editor/PipelineFactory.h"

namespace PeachEditor {

    VkPipelineLayout 
        PipelineFactory::CreatePipelineLayout
        (
            VkDevice device,
            const vector<ShaderCompilerUtils::DescriptorBindingInfo>& descriptorBindings,
