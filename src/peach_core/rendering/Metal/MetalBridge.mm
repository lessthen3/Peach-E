...
extern "C" void 
    PEACH_AssignMetalDeviceToLayer(void* fp_Layer, void* fp_Device)
{
...
extern "C" void* 
    PEACH_GetNextDrawable(void* fp_Layer)
{
...
extern "C" void
    PEACH_FlushCATransaction()
{
    [CATransaction flush]; //commits and flushes any pending implicit CA transaction on calling thread
}
